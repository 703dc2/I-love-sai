document.addEventListener("DOMContentLoaded", () => {
  ...
  const buttons = {
    movieButton:
      "Continue Watching Hitman: Grab as many snacks as possible, get water and drinks, get dessert, cuddle up in bed with your plushies (pretend they are Dhruv), and watch Hitman.",
    triviaButton:
